...
final class ScreenSharingWrapper {
     ...
     */
    private static final String CONFIGURATION_ID = ;
    ...
    public void startTeamViewerSession(Activity activity) {
        ...
        String serviceCaseName = resources.getString(R.string.service_case_name);
        String serviceCaseDescription = resources.getString(R.string.service_case_description);
